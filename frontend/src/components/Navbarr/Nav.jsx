...
//           "http://localhost:5000/api/cart/guest-cart"
//         );
...
//     // Add to cart ke baad cart count update
...
const Nav = () => {
  ...
  const fetchCartCount = async () => {
    try {
      ...
      // Response JSON hai ya nahi check
      const contentType =
  ...
  useEffect(() => {
    ...
    // Add/remove/update cart ke baad
    const updateCartCount = () => {
      fetchCartCount();
    };

    // Login/logout ke baad
